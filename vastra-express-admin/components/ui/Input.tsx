  ...
  return (
    <div className="w-full">
      ...
      <div className="flex">
        ...
        <input
          className={cn(
            'block w-full px-3 py-2 text-sm text-gray-900 border border-gray-300 rounded-lg shadow-sm',
...
export function Select({ label, error, options, placeholder, className, ...props }: SelectProps) {
  return (
    <div className="w-full">
      ...
      <select
        className={cn(
          'block w-full px-3 py-2 text-sm text-gray-900 border border-gray-300 rounded-lg shadow-sm bg-white',
          'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500',
          'disabled:bg-gray-50 disabled:text-gray-500',
